...
def test_parse_bucket_list_response() -> None:
...
def test_parse_bucket_list_response_403() -> None:
    http_response = HttpResponse(
        status_code="403",
        body=b"",
    )
...
def test_inaccessible_bucket() -> None:
...
def test_delete_nonexistent_bucket() -> None:
